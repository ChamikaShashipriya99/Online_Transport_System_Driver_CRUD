...
<head>
    ...
    <title>RideEase - Update Vehicle</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Update Vehicle Details</h1>
            ...
            <div class="col-md-6">
                <form action="${pageContext.request.contextPath}/update" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="pricePerHour" name="pricePerHour" value="${vehicle.pricePerHour}" required>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Update Vehicle</button><br><br>
                    </div>
                </form>
            </div>
        </div>
