...
<%@ page import="com.rideease.model.Vehicle" %>
<%@ page import="com.rideease.dao.VehicleDAO" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>RideEase - Vehicle Profile</title>
    ...
    <nav>
        <div class="container">
            ...
            <ul>
                ...
                <li><a href="register.jsp" class="get-started">Register Vehicle</a></li>
            </ul>
        </div>
    </nav>

    <div class="container mt-5">
        <h1 class="text-center mb-4">Vehicle Profile</h1>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= vehicle.getPricePerHour() %></td>
                    <td>
                        <a href="update?id=<%= vehicle.getId() %>" class="btn btn-warning">Edit</a>
